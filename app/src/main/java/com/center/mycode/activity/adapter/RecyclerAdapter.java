package com.center.mycode.activity.adapter;
...
public class RecyclerAdapter extends UltimateViewAdapter
{
    ...
    {
        if (position < getItemCount() && (customHeaderView != null ? position <= data.size() : position < data.size())
    ...
    static class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            super(view);
            recTxt = (TextView)view.findViewById(R.id.rec_txt);
        }
    }
}
