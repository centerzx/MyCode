...
import com.center.mycode.activity.adapter.RecyclerAdapter;
...
public class RefreshActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        adapter.setCustomLoadMoreView(LayoutInflater.from(this).inflate(R.layout.recycler_loadmore_view, null));
    ...
    private List<String> getData()
    {
        ...
        data.add("satusssssssssssssssssssssssssssssssssssssssssssssssssssssss");
        data.add("duasssssssssssssssssssssssssssssssssssssssssss");
        data.add("tigasssssssssssssssssssssssssssss");
        data.add("empatssssssssssssssssssssssssssssssssssssssssssssssssssssssssss");
        data.add("lima");
        data.add("enam");
        data.add("tujuh");
        data.add("delapan");
